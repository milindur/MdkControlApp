...
namespace MDKControl.iOS
{
    ...
    partial class DeviceViewController
    {
        ...
        UIKit.UITableViewCell ModeAstroTableViewCell { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UITableViewCell ModePanoramaTableViewCell { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UITableViewCell ModeSmsTableViewCell { get; set; }
