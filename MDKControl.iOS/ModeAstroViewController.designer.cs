...
namespace MDKControl.iOS
{
    ...
    partial class ModeAstroViewController
    {
        ...
        UIKit.UILabel HemisphereValueLabel { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIPickerView HemisphereValuePickerView { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UILabel SpeedValueLabel { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIPickerView SpeedValuePickerView { get; set; }
